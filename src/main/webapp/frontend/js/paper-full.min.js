...
var paper = function (t, e) {
    ...
    "undefined" != typeof module && (module.exports = r), r.inject({
        ...
        beans: !1, statics: {
            exports: {}, extend: function st() {
                var t = st.base.apply(this, arguments), e = t.prototype._class;
                ...
                var a = n && n.length, o = i === e;
                i = o ? t.length : i, i > t.length && (i = t.length);
                for (var h = 0; h < a; h++) n[h]._index = i + h;
                if (o) return r.push(t, n), [];
                var u = [i, s];
                n && r.push(u, n);
                for (var l = t.splice.apply(t, u), h = 0, c = l.length; h < c; h++) l[h]._index = e;
                for (var h = i + a, c = t.length; h < c; h++) t[h]._index = h;
                return l
    ...
    var s = {
        ...
        _class: "PaperScope", initialize: function ot() {
            rt = this, this.settings = new r({
                applyMatrix: !0,
                insertItems: !0,
                handleSize: 4,
                hitTolerance: 0
            }), this.project = null, this.projects = [], this.tools = [], this._id = ot._id++, ot._scopes[this._id] = this;
            var e = ot.prototype;
            if (!this.support) {
        ...
        }, version: "0.11.8", getView: function () {
            var t = this.project;
            return t && t._view
        }, getPaper: function () {
            return this
        }, execute: function (t, e) {
            var n = rt.PaperScript.execute(t, this, e);
            return Z.updateFocus(), n
        }, install: function (t) {
            var e = this;
    ...
    var u = new function () {
        ...
        return {
            ...
            solveCubic: function (e, i, r, h, f, d, _) {
                ...
                var M = u.solveQuadratic(e, p, m, f, d, _), T = null == d;
                return isFinite(v) && (0 === M || M > 0 && v !== f[0] && v !== f[1]) && (T || v > d - l && v < _ + l) && (f[M++] = T ? v : t(v, d, _)), M
            }
        }
    }, l = {
        ...
        _class: "Matrix", initialize: function ht(t, e) {
            var n = arguments.length, i = !0;
            if (n >= 6 ? this._set.apply(this, arguments) : 1 === n || 2 === n ? t instanceof ht ? this._set(t._a, t._b, t._c, t._d, t._tx, t._ty, e) : Array.isArray(t) ? this._set.apply(this, e ? t.concat([e]) : t) : i = !1 : n ? i = !1 : this.reset(), !i) throw new Error("Unsupported matrix parameters");
            return this
            ...
            return e && this.translate(e), this._a *= t.x, this._b *= t.x, this._c *= t.y,
        ...
        initialize: function () {
            ...
            var i = t && r.isPlainObject(t), s = i && t.internal === !0, a = this._matrix = new p,
                o = i && t.project || rt.project, h = rt.settings;
            ...
            8 & t && (this._bounds = this._position = this._decomposed = e), 16 & t && (this._globalMatrix = e), i && 72 & t && w._clearBoundsCache(i), 2 & t && w._clearBoundsCache(this), r && r._changed(t, this), n && n._changed(t)
        }, getId: function () {
            return this._id
        }, getName: function () {
            return this._name
        ...
        var e = r.capitalize(t), n = "_" + t, i = {locked: 256, visible: 265};
        this["get" + e] = function () {
            return this[n]
        ...
        beans: !0, getSelection: function () {
            ...
            var e = t ? c : f, n = this._position || (this._position = this._getPositionFromBounds());
        ...
        _hitTest: function (t, e, n) {
            ...
            _getItems: function ft(t, e, n, i, s) {
                if (!i) {
                ...
                for (var d = 0, _ = c && c.length; d < _; d++) {
                    ...
                    if (i.recursive !== !1 && ft(v, e, m, i, s), s && f.length > 0) break
                }
                return f
            }
        }
        ...
        _setStyles: function (t, e, n) {
            ...
            if (i.hasFill() && (t.fillStyle = i.getFillColor().toCanvasStyle(t, r)), i.hasStroke()) {
                ...
                if (s && (t.lineJoin = s), a && (t.lineCap = a), o && (t.miterLimit = o), rt.support.nativeDash) {
            ...
            if (this._visible && 0 !== this._opacity) {
                ...
                if (a.isInvertible()) {
                    ...
                    var o, h, u, l = this._blendMode, c = this._opacity, f = "normal" === l, d = et.nativeModes[l],
                        _ = f && 1 === c || e.dontStart || e.clip || (d || f && c < 1) && this._canComposite(),
                        g = e.pixelRatio || 1;
                    if (!_) {
                        var v = this.getStrokeBounds(r);
                        if (!v.width || !v.height) return void i.pop();
                        u = e.offset, h = e.offset = v.getTopLeft().floor(), o = t, t = tt.getContext(v.getSize().ceil().add(1).multiply(g)), 1 !== g && t.scale(g, g)
                    }
                    t.save();
                    var p = n ? n.appended(s) : this._canScaleStroke && !this.getStrokeScaling(!0) && r,
                        m = !_ && e.clipItem, y = !p || m;
            ...
            if (this._drawSelected || (a = !1), (a || o || h) && this._isUpdated(r)) {
                ...
                if (t.strokeStyle = t.fillStyle = l ? l.toCanvasStyle(t) : "#009dec", a && this._drawSelected(t, c, i), h) {
                    var d = this.getPosition(!0), _ = this._parent, g = _ ? _.localToGlobal(d) : d, v = g.x, p = g.y;
                    t.beginPath(), t.arc(v, p, f, 0, 2 * Math.PI, !0), t.stroke();
                    for (var m = [[0, -1], [1, 0], [0, 1], [-1, 0]], y = f, w = n + 1, x = 0; x < 4; x++) {
                        var b = m[x], C = b[0], S = b[1];
                ...
                if (o) {
                    ...
                    t.beginPath();
                    for (var x = 0; x < 8; x++) t[x ? "lineTo" : "moveTo"](k[x], k[++x]);
                    t.closePath(), t.stroke();
                    for (var x = 0; x < 8; x++) t.fillRect(k[x] - f, k[++x] - f, n, n)
                }
            }
        ...
        _getBounds: function _t(t, e) {
            ...
            return n ? n._getCachedBounds(t && t.appended(n._matrix), r.set({}, e, {stroke: !1})) : _t.base.call(this, t, e)
        },
        _hitTestChildren: function gt(t, e, n) {
            var i = this._getClipItem();
            return (!i || i.contains(t)) && gt.base.call(this, t, e, n, i)
        },
        _draw: function (t, e) {
        ...
        toPath: function (t) {
            ...
            return n.copyAttributes(this), rt.settings.applyMatrix && n.setApplyMatrix(!0), (t === e || t) && n.insertAbove(this), n
        },
        toShape: "#clone",
        _asPathItem: function () {
        ...
        setImage: function (t) {
            function e(t) {
                ...
                e && n.responds(i) && (rt = e._scope, n.emit(i, new $(t)))
            }
        ...
        beans: !1, getSubCanvas: function () {
            ...
            i && (t.globalAlpha = this._opacity, this._setStyles(t, e, n), U.setPrefixed(t, "imageSmoothingEnabled", this._smoothing), t.drawImage(i, -this._size.width / 2, -this._size.height / 2))
        }, _canComposite: function () {
            return !0
        }
    }), k = w.extend({
        ...
        _class: "Segment", beans: !0, _selection: 0, initialize: function (t, n, i, r, s, a) {
            ...
            c > 0 && (null == t || "object" == typeof t ? 1 === c && t && "point" in t ? (o = t.point, h = t.handleIn, u = t.handleOut, l = t.selection) : (o = t, h = n, u = i, l = r) : (o = [t, n], h = i !== e ? [i, r] : null, u = s !== e ? [s, a] : null)), new T(o, this, "_point"), new T(h, this, "_handleIn"), new T(u, this, "_handleOut"), l && this.setSelection(l)
        }, _serialize: function (t, e) {
        ...
        getLength: function () {
            ...
            if (t >= n && t <= i) {
                var s = A.subdivide(this.getValues(), t), a = s[0], o = s[1], h = e || this.hasHandles(),
                    u = this._segment1, l = this._segment2, f = this._path;
                h && (u._handleOut._set(a[2] - a[0], a[3] - a[1]), l._handleIn._set(o[4] - o[6], o[5] - o[7]));
                var d = a[6], _ = a[7],
                    g = new M(new c(d, _), h && new c(a[4] - d, a[5] - _), h && new c(o[2] - d, o[3] - _));
                f ? (f.insert(u._index + 1, g), r = this.getNext()) : (this._segment2 = g, this._changed(), r = new A(g, l))
            }
            return r
        }, splitAt: function (t) {
            var e = this._path;
            ...
            getValues: function (t, e, n, i) {
                ...
                if (r >= s == s >= a && s >= a == a >= o || A.isStraight(t)) n.push(t); else {
                    var h = 3 * (s - a) - r + o, l = 2 * (r + a) - 4 * s, c = s - r, f = 1e-8, d = 1 - f, _ = [],
                        g = u.solveQuadratic(h, l, c, _, f, d);
                    if (g) {
                        _.sort();
                        var v = _[0], p = A.subdivide(t, v);
                        n.push(p[0]), g > 1 && (v = (_[1] - v) / (1 - v), p = A.subdivide(p[1], v), n.push(p[0])), n.push(p[1])
                    } else n.push(t)
                }
                return n
                ...
                if (null === a) for (var o = [e.x, e.y], h = [], u = 0; u < 2; u++) for (var l = A.solveCubic(t, u, o[u], h, 0, 1), f = 0; f < l; f++) {
                    var d = h[f];
                    if (e.isClose(A.getPoint(t, d), s)) return d
                }
                return e.isClose(n, s) ? 0 : e.isClose(i, s) ? 1 : null
            }, getNearestTime: function (t, e) {
                function n(n) {
                    if (n >= 0 && n <= 1) {
                        var i = e.getDistance(A.getPoint(t, n), !0);
                ...
                if (A.isStraight(t)) {
                    ...
                    return l < 1e-12 ? 0 : l > .999999999999 ? 1 : A.getTimeOf(t, new c(i + l * o, r + l * h))
                }
                ...
                for (var e = t.slice(0, 2), n = e.slice(), i = [0, 0], r = 0; r < 2; r++) A._addBounds(t[r], t[r + 2], t[r + 4], t[r + 6], r, 0, e, n, i);
        ...
        beans: !1, getLocationAt: function (t, e) {
        ...
        }, getParameterAt: "#getTimeAt", getTimesWithTangent: function () {
            var t = c.read(arguments);
            return t.isZero() ? [] : A.getTimesWithTangent(this.getValues(), t)
            ...
            var t = c.read(arguments), e = this.getValues(), n = A.getNearestTime(e, t), i = A.getPoint(e, n);
        ...
        return r.each(t, function (t) {
            this[t + "At"] = function (e, n) {
                ...
                return A[t](i, n ? e : A.getTimeAt(i, e))
            ...
            statics: {
                classify: function (t) {
                    ...
                    if (r === e && (r = 0), s === e && (s = 1), A.isStraight(i)) {
                        var o = i;
                        s < 1 && (o = A.subdivide(o, s)[0], r /= s), r > 0 && (o = A.subdivide(o, r)[1]);
        ...
        function e(r, s, a, o, h, u, l, c, f, d, _, g, v) {
            ...
            var p, y, w = 1e-9, x = s[0], b = s[1], C = s[6], S = s[7], k = m.getSignedDistance,
                I = k(x, b, C, S, s[2], s[3]), P = k(x, b, C, S, s[4], s[5]), M = I * P > 0 ? .75 : 4 / 9,
                T = M * Math.min(0, I, P), z = M * Math.max(0, I, P), O = k(x, b, C, S, r[0], r[1]),
                L = k(x, b, C, S, r[2], r[3]), E = k(x, b, C, S, r[4], r[5]), N = k(x, b, C, S, r[6], r[7]),
                B = n(O, L, E, N), F = B[0], j = B[1];
            if (0 === I && 0 === P && 0 === O && 0 === L && 0 === E && 0 === N || null == (p = i(F, j, T, z)) || null == (y = i(F.reverse(), j.reverse(), T, z))) return f;
            var D = d + (_ - d) * p, R = d + (_ - d) * y;
            if (Math.max(v - g, R - D) < w) {
                var q = (D + R) / 2, V = (g + v) / 2;
                t(h, u, l ? o : a, l ? V : q, l ? a : o, l ? q : V)
            } else if (r = A.getPart(r, p, y), y - p > .8) if (R - D > v - g) {
                var U = A.subdivide(r, .5), q = (D + R) / 2;
                f = e(s, U[0], o, a, h, u, !l, c, f, g, v, D, q), f = e(s, U[1], o, a, h, u, !l, c, f, g, v, q, R)
            } else {
                var U = A.subdivide(s, .5), V = (g + v) / 2;
        ...
        function o(e, n, i, r, s, o, h) {
            for (var u = n[0], l = n[1], c = n[6], f = n[7], d = a(e, u, l, c - u, f - l), _ = 0, g = d.length; _ < g; _++) {
                var v = d[_], p = A.getPoint(e, v), m = A.getTimeOf(n, p);
                null !== m && t(s, o, h ? r : i, h ? m : v, h ? i : r, h ? v : m)
            }
        }

        function h(e, n, i, r, s, a) {
            var o = m.intersect(e[0], e[1], e[6], e[7], n[0], n[1], n[6], n[7]);
            o && t(s, a, i, A.getTimeOf(e, o), r, A.getTimeOf(n, o))
        }

        function l(n, i, r, s, a, u) {
            var l = 1e-12, f = Math.min, d = Math.max;
            if (d(n[0], n[2], n[4], n[6]) + l > f(i[0], i[2], i[4], i[6]) && f(n[0], n[2], n[4], n[6]) - l < d(i[0], i[2], i[4], i[6]) && d(n[1], n[3], n[5], n[7]) + l > f(i[1], i[3], i[5], i[7]) && f(n[1], n[3], n[5], n[7]) - l < d(i[1], i[3], i[5], i[7])) {
                var g = _(n, i);
                if (g) for (var v = 0; v < 2; v++) {
                    var p = g[v];
                    t(a, u, r, p[0], s, p[1], !0)
                } else {
                    var m = A.isStraight(n), y = A.isStraight(i), w = m && y, x = m && !y, b = a.length;
                    if ((w ? h : m || y ? o : e)(x ? i : n, x ? n : i, x ? s : r, x ? r : s, a, u, x, 0, 0, 0, 1, 0, 1), !w || a.length === b) for (var v = 0; v < 4; v++) {
                        var C = v >> 1, S = 1 & v, k = 6 * C, I = 6 * S, P = new c(n[k], n[k + 1]),
                            M = new c(i[I], i[I + 1]);
                        P.isClose(M, l) && t(a, u, r, C, s, S)
                    }
                }
            }
            return a
        ...
        function d(t, e, n, i, s, a) {
            var o = !e;
            o && (e = t);
            for (var h, u, c = t.length, d = e.length, _ = [], g = [], v = 0; v < d; v++) _[v] = e[v].getValues(s);
            for (var v = 0; v < c; v++) {
                var p = t[v], m = o ? _[v] : p.getValues(i), y = p.getPath();
                y !== u && (u = y, h = [], g.push(h)), o && f(m, p, h, n);
                for (var w = o ? v + 1 : 0; w < d; w++) {
                    if (a && h.length) return h;
                    l(m, _[w], p, e[w], h, n)
                }
            }
            h = [];
            for (var v = 0, x = g.length; v < x; v++) r.push(h, g[v]);
            return h
        }
        ...
        function _(t, e) {
            ...
            var i = Math.abs, r = m.getDistance, s = 1e-8, a = 1e-7, o = A.isStraight(t), h = A.isStraight(e),
            ...
            for (var y = [t, e], w = [], x = 0; x < 4 && w.length < 2; x++) {
                var b = 1 & x, C = 1 ^ b, S = x >> 1, k = A.getTimeOf(y[b], new c(y[C][S ? 6 : 0], y[C][S ? 7 : 1]));
                if (null != k) {
                    var I = b ? [S, k] : [k, S];
            ...
            if (2 !== w.length) w = null; else if (!u) {
                var P = A.getPart(t, w[0][0], w[1][0]), M = A.getPart(e, w[0][1], w[1][1]);
                (i(M[2] - P[2]) > a || i(M[3] - P[3]) > a || i(M[4] - P[4]) > a || i(M[5] - P[5]) > a) && (w = null)
            }
            return w
        }

        function g(t, e) {
            var n = t[0], i = t[1], r = t[2], s = t[3], a = t[4], o = t[5], h = t[6], l = t[7], c = e.normalize(),
                f = c.x, d = c.y, _ = 3 * h - 9 * a + 9 * r - 3 * n, g = 3 * l - 9 * o + 9 * s - 3 * i,
                v = 6 * a - 12 * r + 6 * n, p = 6 * o - 12 * s + 6 * i, m = 3 * r - 3 * n, y = 3 * s - 3 * i,
                w = 2 * _ * d - 2 * g * f, x = [];
            if (Math.abs(w) < u.CURVETIME_EPSILON) {
                var b = _ * y - g * m, w = _ * p - g * v;
                if (0 != w) {
                    var C = -b / w;
                    C >= 0 && C <= 1 && x.push(C)
                }
                ...
                var S = (v * v - 4 * _ * m) * d * d + (-2 * v * p + 4 * g * m + 4 * _ * y) * f * d + (p * p - 4 * g * y) * f * f,
                    k = v * d - p * f;
                if (S >= 0 && 0 != w) {
                    var I = Math.sqrt(S), P = -(k + I) / w, M = (-k + I) / w;
                    P >= 0 && P <= 1 && x.push(P), M >= 0 && M <= 1 && x.push(M)
                }
            }
            return x
        }
        ...
        return {
            getIntersections: function (t) {
                ...
                return n ? l(e, n, this, t, []) : f(e, this, [])
        ...
        _class: "CurveLocation", initialize: function (t, e, n, i, r) {
            ...
            function t(t, e) {
                var n = t.getValues(), i = A.classify(n).roots || A.getPeaks(n), r = i.length,
                    s = e && r > 1 ? i[r - 1] : r > 0 ? i[0] : .5;
                d.push(A.getLength(n, e ? s : 0, e ? 1 : s) / 2)
            }
        ...
        _class: "PathItem", _selectBounds: !1, _canScaleStroke: !0, beans: !0, initialize: function () {
            ...
            return r || this.getBounds(s).intersects(t.getBounds(a), 1e-12) ? A.getIntersections(this.getCurves(), !r && t.getCurves(), e, s, a, i) : []
            ...
            if (h < u) for (var l = i ? M : L, c = h; c < u; c++) this.add(new l); else h > u && this[i ? "removeSegments" : "removeChildren"](u, h);
        ...
        _class: "Path", _serializeFields: {segments: [], closed: !1}, initialize: function (t) {
            ...
            if (pt.base.call(this, t), 8 & t) {
                if (this._length = this._area = e, 32 & t) this._version++; else if (this._curves) for (var n = 0, i = this._curves.length; n < i; n++) this._curves[n]._changed()
            ...
            if (this._segments.length = 0, this._segmentSelection = 0, this._curves = e, i) {
                var r = t[i - 1];
                "boolean" == typeof r && (this.setClosed(r), i--), this._add(M.readList(t, 0, {}, i))
            }
            ...
            if (!t) {
                ...
                for (var i = 0; i < n; i++) t[i] = new A(this, e[i], e[i + 1] || e[0])
            }
            return t
        ...
        beans: !0, getPathData: function (t, e) {
            ...
            if (a) r.push(n, t); else {
                ...
                for (var o = e + s, u = n.length; o < u; o++) n[o]._index = o
            }
            if (i) {
                var l = this._countCurves(), c = e > 0 && e + s - 1 === l ? e - 1 : e, f = c, d = Math.min(c + s, l);
                t._curves && (i.splice.apply(i, [c, 0].concat(t._curves)), f += t._curves.length);
                for (var o = f; o < d; o++) i.splice(o, 0, new A(this, null, null));
            ...
            if (null == t) {
                ...
                for (var i = 0, r = e.length; i < r; i++) {
                    var s = i + 1 === r;
                    t += A.getArea(A.getValues(e[i], e[s ? 0 : i + 1], null, s && !n))
                }
                this._area = t
            }
            return t
            ...
            if (/^(?:asymmetric|continuous)$/.test(s)) {
                ...
                for (var C = w[0]._x + 2 * w[1]._x, S = w[0]._y + 2 * w[1]._y, k = 2, I = v - 1, P = [C], M = [S], T = [k], z = [], O = [], x = 1; x < v; x++) {
                    var L = x < I, E = L ? 1 : d ? 1 : 2, N = L ? 4 : d ? 2 : 7, B = L ? 4 : d ? 3 : 8,
                        F = L ? 2 : d ? 0 : 1, j = E / k;
                    k = T[x] = N - j, C = P[x] = B * w[x]._x + F * w[x + 1]._x - j * C, S = M[x] = B * w[x]._y + F * w[x + 1]._y - j * S
                }
                z[I] = P[I] / T[I], O[I] = M[I] / T[I];
                for (var x = v - 2; x >= 0; x--) z[x] = (P[x] - z[x + 1]) / T[x], O[x] = (M[x] - O[x + 1]) / T[x];
            ...
            if (null !== k) {
                ...
                if (!d && "miter" === u && m > 1) for (var I = 0; I < m; I++) {
                    var T = p[I];
                    if (t.getDistance(T._point) <= c * k && h(T)) {
                        d = T.getLocation();
                        break
                    }
                }
        ...
        return {
            _draw: function (t, n, i, r) {
                ...
                var a = n.dontStart, o = n.dontFinish || n.clip, h = this.getStyle(), u = h.hasFill(),
                    l = h.hasStroke(), c = h.getDashArray(), f = !rt.support.nativeDash && l && c && c.length;
        ...
        return {
            moveTo: function () {
                ...
                if ("boolean" == typeof v) var y = f.add(_).divide(2),
                    e = y.add(y.subtract(f).rotate(v ? -90 : 90)); else if (r.remain(arguments) <= 2) e = _,
                    _ = c.read(arguments); else {
                    ...
                    var b = r.read(arguments), v = !!r.read(arguments), C = !!r.read(arguments), y = f.add(_).divide(2),
                        S = f.subtract(y).rotate(-b), k = S.x, I = S.y, P = o(w.width), T = o(w.height), A = P * P,
                        z = T * T, O = k * k, L = I * I, E = h(O / A + L / z);
                    if (E > 1 && (P *= E, T *= E, A = P * P, z = T * T), E = (A * z - A * L - z * O) / (A * L + z * O), o(E) < 1e-12 && (E = 0), E < 0) throw new Error("Cannot create an arc with the given arguments");
                    n = new c(P * I / T, -T * k / P).multiply((C === v ? -1 : 1) * h(E)).rotate(b).add(y), a = (new p).translate(n).rotate(b).scale(P, T), s = a._inverseTransform(f), i = s.getDirectedAngle(a._inverseTransform(_)), !v && i > 0 ? i -= 360 : v && i < 0 && (i += 360)
                }
                if (e) {
                    var N = new m(f.add(e).divide(2), e.subtract(f).rotate(90), (!0)),
                        B = new m(e.add(_).divide(2), _.subtract(e).rotate(90), (!0)), F = new m(f, _),
                        j = F.getSide(e);
                    if (n = N.intersect(B, !0), !n) {
                        if (!j) return this.lineTo(_);
                        throw new Error("Cannot create an arc with the given arguments")
                    }
                    s = f.subtract(n), i = s.getDirectedAngle(_.subtract(n));
                    var D = F.getSide(n, !0);
                    0 === D ? i = j * o(i) : j === D && (i += i < 0 ? 360 : -360)
                }
                for (var R = 1e-7, q = o(i), V = q >= 360 ? 4 : Math.ceil((q - R) / 90), U = i / V, H = U * Math.PI / 360, Z = 4 / 3 * Math.sin(H) / (1 + Math.cos(H)), W = [], $ = 0; $ <= V; $++) {
                    ...
                    if ($ < V && (G = s.rotate(90).multiply(Z), a ? (S = a._transformPoint(s), G = a._transformPoint(s.add(G)).subtract(S)) : S = n.add(s)), $) {
                        ...
                        a && (J = a._transformPoint(s.add(J)).subtract(S)), W.push(new M(S, J, G))
        ...
        _getBounds: function (t, e) {
            ...
            getBounds: function (t, e, n, i, r, s) {
                function a(t) {
                    ...
                    for (var e = 0; e < 2; e++) A._addBounds(u[e], u[e + 4], h[e + 2], h[e], e, s ? s[e] : 0, l, c, f);
                    var n = u;
                    u = h, h = n
                }
                ...
                for (var f = new Array(6), d = 1 / 0, _ = -d, v = d, p = _, m = 0, y = t.length; m < y; m++) {
                    ...
                    for (var x = 0; x < 6; x += 2) {
                        var b = x ? s : a, C = b ? b[0] : 0, S = b ? b[1] : 0, k = f[x], I = f[x + 1], P = k - C,
                            M = k + C, T = I - S, A = I + S;
                        P < d && (d = P), M > _ && (_ = M), T < v && (v = T), A > p && (p = A)
                    }
                }
    ...
    L.inject({
        statics: new function () {
            ...
            var n = .5522847498307936,
                i = [new M([-1, 0], [0, n], [0, -n]), new M([0, -1], [-n, 0], [n, 0]), new M([1, 0], [0, -n], [0, n]), new M([0, 1], [n, 0], [-n, 0])];
            return {
                Line: function () {
        ...
        function i(e, i, a, o) {
            function u(t) {
                for (var e = 0, n = t.length; e < n; e++) {
                    var i = t[e];
                    r.push(x, i._segments), r.push(b, i.getCurves()), i._overlapsOnly = !0
                }
            }

            if (o && (0 == o.trace || o.stroke) && /^(subtract|intersect)$/.test(a)) return s(e, i, a);
            var c = t(e, !0), _ = i && e !== i && t(i, !0), g = p[a];
            g[a] = !0, _ && (g.subtract || g.exclude) ^ (_.isClockwise() ^ c.isClockwise()) && _.reverse();
            var v, m = l(z.expand(c.getCrossings(_))), y = c._children || [c], w = _ && (_._children || [_]), x = [],
                b = [];
            if (m.length) {
                u(y), w && u(w);
                for (var C = 0, S = m.length; C < S; C++) f(m[C]._segment, c, _, b, g);
                for (var C = 0, S = x.length; C < S; C++) {
                    var k = x[C], I = k._intersection;
                    k._winding || f(k, c, _, b, g), I && I._overlap || (k._path._overlapsOnly = !1)
                }
                v = d(x, g)
        ...
        function c(t, e, n, i, r) {
            function s(s) {
                ...
                if (!(p < _(a, h) || p > g(a, h))) {
                    ...
                    var C = p === a ? 0 : p === h ? 1 : w > g(f, v, m, b) || x < _(f, v, m, b) ? 1 : A.solveCubic(s, l, p, T, 0, 1) > 0 ? T[0] : 1,
                        P = 0 === C ? f : 1 === C ? b : A.getPoint(s, C)[n ? "y" : "x"], z = a > h ? 1 : -1,
                        O = o[l] > o[l + 6] ? 1 : -1, L = o[u + 6];
                    return p !== a ? (P < w ? S += z : P > x ? k += z : I = !0, P > d - y && P < d + y && (M /= 2)) : (z !== O ? f < w ? S += z : f > x && (k += z) : f != L && (L < x && P > x ? (k += z, I = !0) : L > w && P < w && (S += z, I = !0)), M = 0), o = s, !r && P > w && P < x && 0 === A.getTangent(s, C)[n ? "x" : "y"] && c(t, e, !n, i, !0)
                }
            }

            function a(t) {
                var e = t[l + 0], i = t[l + 2], r = t[l + 4], a = t[l + 6];
                if (p <= g(e, i, r, a) && p >= _(e, i, r, a)) for (var o, h = t[u + 0], c = t[u + 2], f = t[u + 4], d = t[u + 6], v = w > g(h, c, f, d) || x < _(h, c, f, d) ? [t] : A.getMonoCurves(t, n), m = 0, y = v.length; m < y; m++) if (o = s(v[m])) return o
            }
            ...
            for (var o, h, u = n ? 1 : 0, l = 1 ^ u, f = [t.x, t.y], d = f[u], p = f[l], m = 1e-9, y = 1e-6, w = d - m, x = d + m, b = 0, C = 0, S = 0, k = 0, I = !1, P = !1, M = 1, T = [], z = 0, O = e.length; z < O; z++) {
                ...
                if (!(z && e[z - 1]._path === N || (o = null, N._closed || (h = A.getValues(N.getLastCurve().getSegment2(), E.getSegment1(), null, !i), h[l] !== h[l + 6] && (o = h)), o))) {
                    o = B;
                    for (var F = N.getLastCurve(); F && F !== E;) {
                        var j = F.getValues();
                        if (j[l] !== j[l + 6]) {
                            o = j;
                            break
            ...
            for (var d = [.5, .25, .75], s = {
                ...
                if (f <= x) {
                    var l = w.curve, b = l._path, C = b._parent, S = C instanceof E ? C : b,
                        ...
                        P = v(l.getTangentAtTime(k).y) < Math.SQRT1_2, M = null;
                    if (r.subtract && n) {
                        var T = S === e ? n._getWinding(I, P, !0) : e._getWinding(I, P, !0);
                        if (S === e && T.winding || S === n && !T.winding) {
                            if (T.quality < 1) continue;
                            M = {winding: 0, quality: 1}
                        }
                    }
                    M = M || c(I, i, P, !0), M.quality > s.quality && (s = M);
                    break
                }
                f -= x
            }
        ...
        function d(t, e) {
            ...
            for (var h = 0, u = t.length; h < u; h++) {
                ...
                for (; _;) {
                    ...
                    var T = d.getNext();
                    g.add(new M(d._point, f, T && d._handleOut)), d._visited = !0, c.push(d), d = T || d._path.getFirstSegment(), f = T && T._handleIn
                }
            ...
            _getWinding: function (t, e, n) {
                ...
                if (!this.contains(e)) {
                    for (var n = this.getCurves(), i = e.y, r = [], s = [], a = 0, o = n.length; a < o; a++) {
                        ...
                        if (i >= _(u, l, c, f) && i <= g(u, l, c, f)) for (var d = A.getMonoCurves(h), v = 0, p = d.length; v < p; v++) {
                            var m = d[v], y = m[1], w = m[7];
                            if (y !== w && (i >= y && i <= w || i >= w && i <= y)) {
                                var x = i === y ? m[0] : i === w ? m[6] : 1 === A.solveCubic(m, 1, i, s, 0, 1) ? A.getPoint(m, s[0]).x : (m[0] + m[6]) / 2;
                                r.push(x)
                            }
                        }
                    }
    ...
    var N = r.extend({
        _class: "PathFlattener", initialize: function (t, e, n, i, r) {
            ...
            for (var i = this._get(e), r = this._get(n), s = i.index, a = r.index; s <= a; s++) {
                var o = A.getPart(this.curves[s], s === i.index ? i.time : 0, s === r.index ? r.time : 1);
        ...
        this[t + "At"] = function (e) {
            var n = this._get(e);
            return A[t](this.curves[n.index], n.time)
        }
    }, {})), B = r.extend({
        initialize: function (t) {
            ...
            if (a(I) > s) {
                ...
                var T = l[0][0] + l[0][1], A = l[1][0] + l[1][1];
                S = k = a(T) > s ? c[0] / T : a(A) > s ? c[1] / A : 0
            }
        ...
        function t(t) {
            ...
            if (r) {
                ...
                s = r[1], i = r[2].split(/[,\s]+/g);
                for (var l = "hsl" === s, h = 0, c = Math.min(i.length, 4); h < c; h++) {
                    var f = i[h], u = parseFloat(f);
                    if (l) if (0 === h) {
                        var d = f.match(/([a-z]*)$/)[1];
                        u *= {turn: 360, rad: 180 / Math.PI, grad: .9}[d] || 1
                    } else h < 3 && (u /= 100); else h < 3 && (u /= 255);
                    i[h] = u
                }
            } else {
                var _ = a[t];
                if (!_) if (n) {
                    ...
                    var g = e.getImageData(0, 0, 1, 1).data;
                    _ = a[t] = [g[0] / 255, g[1] / 255, g[2] / 255]
                } else _ = [0, 0, 0];
                i = _.slice()
            }
            return [s, i]
        ...
        var e, i = {
            ...
            }, s = {}, a = {transparent: [0, 0, 0, 0]},
            o = [[0, 3, 1], [2, 0, 1], [1, 0, 3], [1, 2, 0], [3, 1, 0], [0, 1, 2]], u = {
            ...
            _class: "Color", _readIndex: !0, initialize: function l(e) {
                ...
                if ("string" === d && e in i && (n = e, e = u[1], Array.isArray(e) ? (a = e, o = u[2]) : (c && (f = 1), u = r.slice(u, 1), d = typeof e)), !a) {
                    if (h = "number" === d ? u : "object" === d && null != e.length ? e : null) {
                        ...
                        var g = t(e);
                        n = g[0], a = g[1], 4 === a.length && (o = a[3], a.length--)
                        ...
                        var y = i[n], w = s[n];
                        this._components = a = [];
                        for (var v = 0, p = y.length; v < p; v++) {
                            var x = e[y[v]];
                            null == x && !v && "gradient" === n && "stops" in e && (x = {
                                stops: e.stops,
                                radial: e.radial
                            }), x = w[v].call(this, x), null != x && (a[v] = x)
                        }
                        o = e.alpha
                    }
                    c && n && (f = 1)
                ...
                if (this._type = n || "rgb", !a) {
                    this._components = a = [];
                    for (var w = s[this._type], v = 0, p = w.length; v < p; v++) {
                        var x = w[v].call(this, h && h[v]);
                        null != x && (a[v] = x)
                    }
                }
        ...
        return r.each(n, function (t, n) {
            ...
            o[f] = function (t) {
                ...
                if (s && s.length > 0 && !(r instanceof E)) for (var a = 0, o = s.length; a < o; a++) s[a]._style[f](t); else if (n in this._defaults) {
                    ...
                    h !== t && (i && (h && h._owner !== e && (h._owner = e, h._canvasStyle = null), t && t.constructor === D && (t._owner && (t = t.clone()), t._owner = r)), this._values[n] = t, r && r._changed(l || 129))
                }
            }, o[d] = function (t) {
        ...
        set: function (t) {
            ...
            var t = Ct.base.call(this), e = this.getFontSize();
        ...
        add: function (t, e) {
            if (t) for (var n in e) for (var r = e[n], s = n.split(/[\s,]+/g), a = 0, o = s.length; a < o; a++) {
                var h = s[a], u = t === i && ("touchstart" === h || "touchmove" === h) && {passive: !1};
    ...
    var Z = r.extend(s, {
        _class: "View", initialize: function St(t, e) {
            function r(t) {
            ...
            var o;
            if (n && e) {
                this._id = e.getAttribute("id"), null == this._id && e.setAttribute("id", this._id = "view-" + St._id++), H.add(e, this._viewEvents);
                var h = "none";
            ...
            this._project = t, this._scope = t._scope, this._element = e, this._pixelRatio || (this._pixelRatio = n && n.devicePixelRatio || 1), this._setElementSize(o.width, o.height), this._viewSize = o, St._views.push(this), St._viewsById[this._id] = this, (this._matrix = new p)._owner = this, St._focused || (St._focused = this), this._frameItems = {}, this._frameItemCount = 0, this._itemEvents = {
                "native": {},
                virtual: {}
            }, this._autoUpdate = !rt.agent.node, this._needsUpdate = !1
        }, remove: function () {
        ...
        if (n) {
            ...
            var p, m, y, w, x, b, C, S, k, I = !1, P = !1, M = {doubleclick: "click", mousedrag: "mousemove"}, T = !1,
                A = {
            ...
            return {
                _viewEvents: g, _handleMouseEvent: function (t, e, n) {
                    ...
                    if (v[t.substr(5)] = !0, o && _ !== x && (x && s(x, null, "mouseleave", e, n), _ && s(_, null, "mouseenter", e, n), x = _), T ^ c && (s(this, null, c ? "mouseenter" : "mouseleave", e, n), p = c ? this : null, g = !0), !c && !v.drag || n.equals(y) || (a(this, _, h ? t : "mousemove", e, n, y), g = !0), T = c, v.down && c || v.up && m) {
                        if (a(this, _, t, e, n, m), v.down) {
                            if (k = _ === C && Date.now() - S < 300, w = C = _, !P && _) {
                                for (var M = _; M && !M.responds("mousedrag");) M = M._parent;
                                M && (b = _)
                            }
                            m = n
                    ...
                    updateFocus: e, _resetState: function () {
        ...
        _class: "CanvasView", initialize: function (t, e) {
            ...
            if (It.base.call(this, t * n, e * n), 1 !== n) {
            ...
            var e, n = rt.agent;
            if (n && n.firefox) e = Pt.base.call(this, t); else {
        ...
        _handleMouseEvent: function (t, e, n, i) {
            function r(t, e) {
                ...
                if (a) {
                    if (c._moveCount >= 0 && r.equals(s)) return !1;
                    if (s && (null != t || null != e)) {
            ...
            rt = this._scope, i.drag && !this.responds(t) && (t = "mousemove");
    ...
    new function () {
        ...
        function u(t, e, n, i) {
            var r = t.childNodes, s = "clippath" === e, a = "defs" === e, o = new x, h = o._project,
                u = h._currentStyle, l = [];
            if (s || a || (o = k(o, t, i), h._currentStyle = o._style.clone()), i) for (var c = t.querySelectorAll("defs"), f = 0, d = c.length; f < d; f++) M(c[f], n, !1);
            for (var f = 0, d = r.length; f < d; f++) {
                var _, g = r[f];
                1 !== g.nodeType || /^defs$/i.test(g.nodeName) || !(_ = M(g, n, !1)) || _ instanceof I || l.push(_)
            }
        ...
        function M(t, e, n) {
            ...
            n && l && (A = rt.getView().getSize(), A = o(t, null, null, !0) || A, s = nt.create("svg", {style: "stroke-width: 1px; stroke-miterlimit: 10"}), a = t.parentNode, h = t.nextSibling, s.appendChild(t), c.appendChild(s));
            var f = rt.settings, d = f.applyMatrix, _ = f.insertItems;
        ...
        function T(n, r, s) {
            function a(i) {
                try {
                    ...
                    rt = h, u = M(a, r, !0), r && r.insert === !1 || s._insertItem(e, u);
                    var l = r.onLoad;
                    l && l(u, i)
                } catch (c) {
                    o(c)
        ...
        var A, z = {}, E = {
            "#document": function (t, e, n, i) {
                for (var r = t.childNodes, s = 0, a = r.length; s < a; s++) {
                    var o = r[s];
                    if (1 === o.nodeType) return M(o, n, i)
                }
            },
            g: u,
            svg: u,
            ...
            image: function (t) {
                ...
                return e.on("load", function () {
                    var e = o(t);
                    this.setSize(e);
                    var n = a(t).add(e.divide(2));
                    this._matrix.append((new p).translate(n))
                }), e
            },
        ...
        function h(r, s) {
                ...
                if (t) {
                    ...
                    switch (t.type) {
                        ...
                        case"ExportDefaultDeclaration":
                            u({range: [t.start, t.declaration.start]}, "module.exports = ");
                            break;
                        case"ExportNamedDeclaration":
                            var m = t.declaration, y = t.specifiers;
                            if (m) {
                                var b = m.declarations;
            ...
            if (!r) return "";
            s = s || {};
            var f, d = [], _ = s.url || "", g = rt.agent, v = g.versionNumber, p = !1, m = s.sourceMaps,
                y = s.source || r, b = /\r\n|\n|\r/gm, C = s.offset || 0;
        ...
        function u(t, e, n) {
            ...
            t = p.code, a({
                ...
                view: l,
                tool: f
            }, !0), a(e), t = "var module = { exports: {} }; " + t;
            var m = r.each(_, function (e) {
                new RegExp("\\s+" + e + "\\b").test(t) && (g.push(e), this.push("module.exports." + e + " = " + e + ";"))
            }, []).join("\n");
            m && (t += "\n" + m), t += "\nreturn module.exports;";
            var y = rt.agent;
            if (i && (y.chrome || y.firefox && y.versionNumber < 40)) {
                var w = i.createElement("script"), x = i.head || i.getElementsByTagName("head")[0];
            ...
            var m = u && u.apply(e, v), b = m || {};
            return r.each(d, function (t) {
                var e = b[t];
                e && (f[t] = e)
            }), l && (b.onResize && l.setOnResize(b.onResize), l.emit("resize", {
                size: l.size,
                delta: new c
            }), b.onFrame && l.setOnFrame(b.onFrame), l.requestUpdate()), m
        }
        ...
        if (!v) {
            ...
            v = m = y = {}, function (t, e) {
                ...
                function d(t) {
                    var e = ft.charCodeAt(pt + 1);
                    return e === t ? w(124 === t ? Pe : Me, 2) : 61 === e ? w(Se, 2) : w(124 === t ? Te : ze, 1)
                }

                function _() {
                    var t = ft.charCodeAt(pt + 1);
                    return 61 === t ? w(Se, 2) : w(Ae, 1)
                }
                ...
                function y(t) {
                    ...
                    if (pt >= dt) return a(jt);
                    var e = ft.charCodeAt(pt);
                    if (Ke(e) || 92 === e) return M();
                    var i = m(e);
                    if (i === !1) {
                        var s = String.fromCharCode(e);
                        if ("\\" === s || $e.test(s)) return M();
                ...
                function P() {
                    ...
                    for (var t, e = !0, i = pt; ;) {
                        ...
                        if (Ye(r)) je && (t += ft.charAt(pt)), ++pt; else {
                            if (92 !== r) break;
                            je || (t = ft.slice(i, pt)), je = !0, 117 != ft.charCodeAt(++pt) && n(pt, "Expecting Unicode escape sequence \\uXXXX"), ++pt;
                ...
                function U(t) {
                    Pt = Mt = pt, ct.locations && (Tt = new r), At = Ot = null, zt = [], y();
                    var e = t || L(), n = !0;
                    for (t || (e.body = []); bt !== jt;) {
                        var i = H();
                        e.body.push(i), n && B(i) && A(!0), n = !1
                    }
                    return N(e, "Program")
                }
                ...
                function H() {
                    ...
                    switch (t) {
                        ...
                        case Vt:
                            T();
                            var i = t === Dt;
                            F(me) || j() ? e.label = null : bt !== Ft ? q() : (e.label = lt(), D());
                        ...
                        case Ut:
                            return T(), D(), N(e, "DebuggerStatement");
                        case Zt:
                            return T(), zt.push(Qe), e.body = H(), zt.pop(), R(ne), e.test = Z(), D(), N(e, "DoWhileStatement");
                        case Gt:
                            if (T(), zt.push(Qe), R(ge), bt === me) return $(e, null);
                            if (bt === ee) {
                                var a = L();
                                return T(), J(a, !0), N(a, "VariableDeclaration"), 1 === a.declarations.length && F(ue) ? G(e, a) : $(e, a)
                            }
                            var a = X(!1, !0);
                            return F(ue) ? (V(a), G(e, a)) : $(e, a);
                        case Jt:
                            return T(), ht(e, !0);
                        case Xt:
                            return T(), e.test = Z(), e.consequent = H(), e.alternate = F(Wt) ? H() : null, N(e, "IfStatement");
                        case Kt:
                            return At || ct.allowReturnOutsideFunction || n(mt, "'return' outside of function"), T(), F(me) || j() ? e.argument = null : (e.argument = X(), D()), N(e, "ReturnStatement");
                        case Yt:
                            T(), e.discriminant = Z(), e.cases = [], R(de), zt.push(tn);
                            for (var o, h; bt != _e;) if (bt === Rt || bt === Ht) {
                                var u = bt === Rt;
                                o && N(o, "SwitchCase"), e.cases.push(o = L()), o.consequent = [], T(), u ? o.test = X() : (h && n(Pt, "Multiple default clauses"), h = !0, o.test = null), R(ye)
                            } else o || q(), o.consequent.push(H());
                            return o && N(o, "SwitchCase"), T(), zt.pop(), N(e, "SwitchStatement");
                        case Qt:
                            return T(), Je.test(ft.slice(Mt, mt)) && n(Mt, "Illegal newline after throw"), e.argument = X(), D(), N(e, "ThrowStatement");
                        case te:
                            if (T(), e.block = W(), e.handler = null, bt === qt) {
                                var l = L();
                                T(), R(ge), l.param = lt(), Ot && Ve(l.param.name) && n(l.param.start, "Binding " + l.param.name + " in strict mode"), R(ve), l.guard = null, l.body = W(), e.handler = N(l, "CatchClause")
                            }
                            return e.guardedHandlers = Lt, e.finalizer = F($t) ? W() : null, e.handler || e.finalizer || n(e.start, "Missing catch or finally clause"), N(e, "TryStatement");
                        case ee:
                            return T(), J(e), D(), N(e, "VariableDeclaration");
                        case ne:
                            return T(), e.test = Z(), zt.push(Qe), e.body = H(), zt.pop(), N(e, "WhileStatement");
                        case ie:
                            return Ot && n(mt, "'with' in strict mode"), T(), e.object = Z(), e.body = H(), N(e, "WithStatement");
                        case de:
                            return W();
                        case me:
                            return T(), N(e, "EmptyStatement");
                        default:
                            var c = Ct, f = X();
                            if (t === Ft && "Identifier" === f.type && F(ye)) {
                ...
                function W(t) {
                    var e, n = L(), i = !0, r = !1;
                    for (n.body = [], R(de); !F(_e);) {
                        var s = H();
                        n.body.push(s), i && t && B(s) && (e = r, A(r = !0)), i = !1
                    }
                ...
                function J(t, e) {
                    for (t.declarations = [], t.kind = "var"; ;) {
                        var i = L();
                        if (i.id = lt(), Ot && Ve(i.id.name) && n(i.id.start, "Binding " + i.id.name + " in strict mode"), i.init = F(Ce) ? X(!0, e) : null, t.declarations.push(N(i, "VariableDeclarator")), !F(pe)) break
                    }
                    return t
                }
                ...
                function X(t, e) {
                    ...
                    if (!t && bt === pe) {
                        var i = E(n);
                        for (i.expressions = [n]; F(pe);) i.expressions.push(K(e));
                ...
                function K(t) {
                    ...
                    if (bt.isAssign) {
                        var n = E(e);
                        return n.operator = Ct, n.left = e, T(), n.right = K(t), V(e), N(n, "AssignmentExpression")
                    }
                    return e
                }
                ...
                function et() {
                    if (bt.prefix) {
                        ...
                        return t.operator = Ct, t.prefix = !0, St = !0, T(), t.argument = et(), e ? V(t.argument) : Ot && "delete" === t.operator && "Identifier" === t.argument.type && n(t.start, "Deleting local variable in strict mode"), N(t, e ? "UpdateExpression" : "UnaryExpression")
                    }
                    for (var i = nt(); bt.postfix && !j();) {
                        var t = E(i);
                        t.operator = Ct, t.prefix = !1, t.argument = i, V(i), T(), i = N(t, "UpdateExpression")
                    }
                    return i
                }
                ...
                function rt() {
                    switch (bt) {
                        ...
                        case Nt:
                            var t = L();
                            return t.value = Ct, t.raw = ft.slice(mt, yt), T(), N(t, "Literal");
                        case ae:
                        case oe:
                        case he:
                            var t = L();
                            return t.value = bt.atomValue, t.raw = bt.keyword, T(), N(t, "Literal");
                        case ge:
                            var e = wt, n = mt;
                            T();
                            var i = X();
                        ...
                        case ce:
                            var t = L();
                            return T(), t.elements = ut(fe, !0, !0), N(t, "ArrayExpression");
                        case de:
                            return at();
                        case Jt:
                            var t = L();
                ...
                function st() {
                    var t = L();
                    return T(), t.callee = it(rt(), !0), F(ge) ? t.arguments = ut(ve, !1) : t.arguments = Lt, N(t, "NewExpression")
                }

                function at() {
                    var t = L(), e = !0, i = !1;
                    for (t.properties = [], T(); !F(_e);) {
                        if (e) e = !1; else if (R(pe), ct.allowTrailingCommas && F(_e)) break;
                        var r, s = {key: ot()}, a = !1;
                        if (F(ye) ? (s.value = X(!0), r = s.kind = "init") : ct.ecmaVersion >= 5 && "Identifier" === s.key.type && ("get" === s.key.name || "set" === s.key.name) ? (a = i = !0, r = s.kind = s.key.name, s.key = ot(), bt !== ge && q(), s.value = ht(L(), !1)) : q(), "Identifier" === s.key.type && (Ot || i)) for (var o = 0; o < t.properties.length; ++o) {
                ...
                function ht(t, e) {
                    bt === Ft ? t.id = lt() : e ? q() : t.id = null, t.params = [];
                    var i = !0;
                    for (R(ge); !F(ve);) i ? i = !1 : R(pe), t.params.push(lt());
                    var r = At, s = zt;
                    if (At = !0, zt = [], t.body = W(!0), At = r, zt = s, Ot || t.body.body.length && B(t.body.body[0])) for (var a = t.id ? -1 : 0; a < t.params.length; ++a) {
                ...
                function ut(t, e, n) {
                    for (var i = [], r = !0; !F(t);) {
                        if (r) r = !1; else if (R(pe), e && ct.allowTrailingCommas && F(t)) break;
                ...
                function lt(t) {
                    var e = L();
                    return t && "everywhere" == ct.forbidReserved && (t = !1), bt === Ft ? (!t && (ct.forbidReserved && (3 === ct.ecmaVersion ? De : Re)(Ct) || Ot && qe(Ct)) && ft.slice(mt, yt).indexOf("\\") == -1 && n(mt, "The keyword '" + Ct + "' is reserved"), e.name = Ct) : t && bt.keyword ? e.name = bt.keyword : q(), St = !1, T(), N(e, "Identifier")
                }
                ...
                var pt, mt, yt, wt, xt, bt, Ct, St, kt, It, Pt, Mt, Tt, At, zt, Ot, Lt = [], Et = {type: "num"},
                    Nt = {type: "regexp"}, Bt = {type: "string"}, Ft = {type: "name"}, jt = {type: "eof"},
                    ...
                    Kt = {keyword: "return", beforeExpr: !0}, Yt = {
                        keyword: "switch"
                    ...
                    Ie = {prefix: !0, beforeExpr: !0}, Pe = {binop: 1, beforeExpr: !0}, Me = {binop: 2, beforeExpr: !0},
                    Te = {binop: 3, beforeExpr: !0}, Ae = {binop: 4, beforeExpr: !0}, ze = {binop: 5, beforeExpr: !0},
                ...
                for (var Fe in le) t.tokTypes["_" + Fe] = le[Fe];
                var je,
    ...
    return rt.agent.node && require("./node/extend.js")(rt), "function" == typeof define && define.amd ? define("paper", rt) : "object" == typeof module && module && (module.exports = rt), rt
